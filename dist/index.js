...
exports.default = {
  ...
  table: {
    ...
    addRowBefore: {
      ...
      content: 'Row before',
      active: _prosemirrorTables.addRowBefore, // TOOD: active -> select
      run: _prosemirrorTables.addRowBefore
    },
    addRowAfter: {
      title: 'Insert row after selected',
      content: 'Row after',
      active: _prosemirrorTables.addRowAfter, // TOOD: active -> select
      run: _prosemirrorTables.addRowAfter
    },
    mergeCells: {
      title: 'Merge selected cells',
      content: 'Merge',
      active: _prosemirrorTables.mergeCells, // TOOD: active -> select
      run: _prosemirrorTables.mergeCells
    }
  }
};
